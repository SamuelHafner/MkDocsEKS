...
Es erscheinen in der ersten Tabellenspalte das Icon :fontawesome-solid-caret-right: bzw. :fontawesome-solid-caret-down:. Mit diesen Icons können einzelne Gruppierungen ein- und aufgeklappt werden. Siehe hierzu auch die [:fontawesome-solid-caret-right::fontawesome-solid-caret-down: Icons](/RFSCOUT/20.13.21/sp/appendix/icon.html#caret-right-und-caret-down).
...
Siehe hierzu auch die [Liste Einklappen und Ausklappen](/RFSCOUT/20.13.21/sp/appendix/icon.html#liste-einklappen-und-ausklappen).